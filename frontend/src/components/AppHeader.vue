...
<template>
  <header class="top-bar">
    <a class="brand" href="#" aria-label="집다움 홈" @click.prevent="emit('home')">
      <span class="brand-mark">Z</span>
      <span>집다움</span>
    </a>

    <nav class="main-nav" aria-label="주요 메뉴">
      <a class="active" href="#" @click.prevent="emit('home')">실거래가 검색</a>
      <a href="#">관심지역</a>
      <a href="#">알림</a>
      <a href="#">마이페이지</a>
    </nav>
    ...
    <div v-else class="account-actions">
      <RouterLink class="ghost-button" :to="{ name: 'login' }">로그인</RouterLink>
